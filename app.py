...
def main():
    ...
    st.markdown(
        f'<img src="data:image/gif;base64,{data_url}" alt="Hello There!  Welcome to the Ramp!" style="width:100vw; max-width:100%; position:relative; left:70%; right:70%; margin-left:-50vw; margin-right:-50vw;">',
